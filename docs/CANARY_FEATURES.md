...
| Sidebar categories and manual channel order | Integrated; pointer and keyboard ordering, safe category lifecycle, startup-race-safe encrypted relay sync, WKWebView-safe manual-row painting | `3a054a9b`, `32abd775`, `b51ef529` | focused upstream branch `fizz/sidebar-categories-manual-order` |
