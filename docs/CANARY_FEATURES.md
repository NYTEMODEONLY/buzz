...
| Sidebar categories and manual channel order | Integrated; pointer and keyboard ordering, safe category lifecycle, encrypted relay-scoped sync | `3a054a9b` | focused upstream branch `fizz/sidebar-categories-manual-order` |
